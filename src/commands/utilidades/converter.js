...
export default familia({
  ...
  subs: [
    ...
    conversor('volume', 'Converte volumes entre litros, galões e medidas de receita.'),
    conversor('area', 'Converte áreas entre metros quadrados, hectares, acres e alqueires.'),
    conversor('velocidade', 'Converte km/h, m/s, milhas por hora, nós e mach.'),
    conversor('tempo', 'Converte durações entre segundos, horas, dias, meses e anos.'),
    conversor('dados', 'Converte tamanhos entre bytes, megabytes e gibibytes.'),
    conversor('energia', 'Converte energia entre joules, calorias e quilowatt-hora.'),
    conversor('pressao', 'Converte pressão entre pascal, bar, atmosfera e psi.'),
    {
      name: 'temperatura',
    ...
    conversor('angulo', 'Converte ângulos entre graus, radianos e grados.'),
    conversor('frequencia', 'Converte frequências entre hertz, quilohertz, megahertz e gigahertz.'),
    conversor('taxa', 'Converte velocidade de conexão entre bps, Kbps, Mbps e Gbps.'),
    conversor('cozinha', 'Converte medidas de receita entre xícaras, colheres e mililitros.'),
    {
      name: 'combustivel',
